...
1. The `main.py` already has the demo code as endpoint `/event_receive`.  Please replace the `table_id` in the code to your case.
...
2. Then, create a new Eventarc trigger for the endpoint `/event_receive` on the Cloud Run service's TRIGGER panel, similar to what we did before:

	![image-20230831161329519](img/image-20230831161329519.png)

3. Create a BigQuery dataset named `cloud_run_tut_dataset` in BigQuery.
